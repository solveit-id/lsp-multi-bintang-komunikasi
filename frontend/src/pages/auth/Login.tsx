    ...
    >
      ...
      <div className="mx-auto flex min-h-[calc(100vh-65px)] w-full max-w-6xl flex-col lg:flex-row lg:items-center">
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-10 sm:px-10 lg:w-1/2 lg:py-14">
          <div className="w-full max-w-lg rounded-2xl border border-[#F1EFE9] bg-white p-7 shadow-[0_1px_2px_rgba(30,42,69,0.04),0_12px_32px_-16px_rgba(30,42,69,0.12)] sm:p-9">
            <h2
            ...
            <form onSubmit={handleSubmit} noValidate className="mt-7 space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label htmlFor="password" className="block text-sm font-medium text-[#1E2A45]">
                    Kata sandi
                  </label>
                  <a
                    href="#lupa-sandi"
                    className="text-xs font-medium text-[#8A6A0F] hover:text-[#F4C233] underline-offset-2 hover:underline"
                  >
                    Lupa sandi?
                  </a>
                </div>
                <div className="relative mt-1.5">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 flex items-center pr-3 text-[#94A3B8] hover:text-[#1E2A45] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F4C233] rounded"
                  >
            ...
            <p className="mt-7 text-center text-sm text-[#64748B]">
              Belum punya akun?{" "}
              <a href="/register" className="font-semibold text-[#1E2A45] underline-offset-2 hover:underline">
                Daftar
              </a>
            </p>
          </div>
